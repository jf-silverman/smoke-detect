...
those labels live in research/findings - confuser-corpus.md. The images themselves stay gitignored,
...
# see research/findings - confuser-corpus.md. If you change --k or the features, re-inspect and
